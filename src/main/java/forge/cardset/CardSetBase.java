 ...
 * 
 */
public abstract class CardSetBase implements Serializable, Comparable<CardSetBase> {
     ...
     */
    public CardSetBase(final String name0) {
        this.name = name0;
    }
     ...
     */
    @Override
    public int compareTo(final CardSetBase d) {
