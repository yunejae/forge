...
public enum VProbabilities implements IVDoc<CProbabilities> {
   ...
   // private final JLabel lblExplanation = new FLabel.Builder()
    ...
    private <T extends InventoryItem, TModel extends CardSetBase> JLabel buildLabel(final boolean zebra) {
        ...
        lbl.addMouseListener(new MouseAdapter() {
            ...
            public void mouseEntered(final MouseEvent e) {
                ...
                final List<PaperCard> cards = (List<PaperCard>) ed.getTableCardSet().getCards().toFlatList();
                ...
                for (PaperCard c : cards) {
                    ...
                    if (name2.equals(name1.substring(0, name2.length()))) {
                        CCardSetEditorUI.SINGLETON_INSTANCE.setCard(c);
                        break;
                    }
                }
            }
