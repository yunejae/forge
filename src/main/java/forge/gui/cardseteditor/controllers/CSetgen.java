...
import forge.gui.cardseteditor.views.VSetgen;
 ...
 *
 */
public enum CSetgen implements ICDoc {
    /** */
    SINGLETON_INSTANCE;
    ...
    public void initialize() {
        ...
        ((FLabel) VSetgen.SINGLETON_INSTANCE.getBtnRandDeck2()).setCommand(new Command() {
            @Override  public void run() { newGenerateConstructed(2); } });

        ((FLabel) VSetgen.SINGLETON_INSTANCE.getBtnRandDeck3()).setCommand(new Command() {
            @Override  public void run() { newGenerateConstructed(3); } });

        ((FLabel) VSetgen.SINGLETON_INSTANCE.getBtnRandDeck5()).setCommand(new Command() {
